    ...
    <>
      ...
      <BackgroundDots blockRef={contentRef as React.RefObject<HTMLDivElement>} allowPointerEvents>
        ...
        >
          <div
            ref={contentRef}
            className="flex flex-col w-[80vw] h-[80vh] sm:h-[75vh] md:h-[70vh] lg:h-[65vh] xl:h-[60vh] sm:max-w-[50vw] lg:max-w-[50vw] xl:max-w-[25vw] p-5 justify-center content-center shadow-lg shadow-black/20 dark:shadow-white/20 bg-white dark:bg-neutral-900 rounded-lg overflow-y-auto"
          >
